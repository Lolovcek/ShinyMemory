...
public class RenderBatch {
    ...
    public RenderBatch(int maxBatchSize) {
        this.shader = AssetPool.getShader("assets/shaders/defaultShader.glsl");
    ...
    public void render() {
        ...
        // use shader
        this.shader.use();
        this.shader.uploadMat4f("uProjectionMatrix", GameWindow.getScene().getCamera().getProjectionMatrix());
        this.shader.uploadMat4f("uViewMatrix", GameWindow.getScene().getCamera().getViewMatrix());
